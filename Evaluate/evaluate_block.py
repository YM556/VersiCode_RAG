...
block_json_path = '/Users/qingyuanzii/Desktop/Versi-Code-Gen/VerisiCode-RAG/Generation/together_ai/tmp/meta-llama/Llama-3-70b-chat-hf/stackoverflow_block.json'
...
for data in data_list[:200]:
    model_output_list = eval(data['model_output_token_clear']) #change block or token or line
    temp_list = []
