...
def build_samples(sample_source:str,sample_num):
    ...
    if sample_source in sources:
        sample_path = os.path.join(prefix_path,'VersiCode/data/VersiCode_Benchmark/VersiCode_Benchmark/code_completion/',sample_source,'{}_line.json'.format(sample_source))
        ...
        for source in sources:
            sample_paths.append(os.path.join(prefix_path,'VersiCode/data/VersiCode_Benchmark/VersiCode_Benchmark/code_completion/',source, '{}_line.json'.format(source)))
...
save_folder_path = "./tmp/line_results/"
if not os.path.exists(save_folder_path):
    os.makedirs(save_folder_path)
save_json_path = os.path.join(save_folder_path, "test_line_lib_graph.jsonl")
