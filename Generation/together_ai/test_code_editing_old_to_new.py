...
json_path = '/Volumes/kjz-SSD/Datasets/VersiCode/data/VersiCode_Benchmark/VersiCode_Benchmark/code_editing/code_editing_old_to_new.json'
...
save_folder_path = os.path.join('../results_gen/code_editing/old_to_new/without_rag', model_name)
if not os.path.exists(save_folder_path):
    os.makedirs(save_folder_path)
save_json_path = os.path.join(save_folder_path, json_path.split('/')[-1])
